...
la carpeta de donde leímos los datos geospaciales vectoriales tenía muchos archivos.
...
un *shapefile* (un formato muy común). Un *shapefile* es un grupo de archivos que 
contienen geometrías e información de acuerdo a un estándar especificado por el Insituto de 
...
de los objetos, en el caso de `ine_depto` hay un renglón por polígono, es decir, 
cada línea contiene las características de un departamento.
...
En cuanto a la columna **geometry**, ésta  puede almacenar distintos tipos de 
datos vectoriales. Para construir datos vectoriales necesitas puntos, líneas y 
polígonos, que corresponden a los datos vectoriales primarios (los puntos forman
líneas, y las líneas polígonos. Algunas de las geometrías más comunes están 
...
para proyectar es
utilizar _superficies de desarrollo_ y después aplanar la superficie. 
